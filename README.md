...
**Code:** [`Pyomo Athletics Scheduling Optimization.ipynb`](https://github.com/bmaddry/Data_Analytics_Portfolio/blob/main/Python/Pyomo_Athletics_Scheduling_Optimzation.ipynb)
...
**Skills:** Data Visualization, Exploratory Data Analysis, Calculated Fields, Interactive Dashboard Design
